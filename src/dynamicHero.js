...
function setBg() {
	...
	function showBg() {
		...
		if (window.matchMedia('(max-width:600px)').matches) {
			afternoonArray = [
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360301/new-portfolio/hero/brown-trench-coat-on-wooden-rack-821357-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360301/new-portfolio/hero/brown-and-green-mountain-view-photo-842711-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360291/new-portfolio/hero/photo-of-keyboard-near-mouse-3184460-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360289/new-portfolio/hero/america-arid-bushes-california-221148-s.jpg'
			];
		}
		...
		if (window.matchMedia('(max-width:600px)').matches) {
			eveningArray = [
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360324/new-portfolio/hero/twisted-building-during-nighttime-1470405-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360278/new-portfolio/hero/beautiful-beauty-blue-bright-414612-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360287/new-portfolio/hero/landscape-photo-of-mountain-with-polar-lights-1434608-s.jpg',
				'https://res.cloudinary.com/stealthman22/image/upload/v1586360310/new-portfolio/hero/photo-of-toronto-cityscape-at-night-2478248-s.jpg'
			];
		}
